...
Introducción al desarrollo web desde el diseño (DNO096) es un Optativo de Profundización (OPR) a cargo del profesor [Felipe Alberto Cortez Orellana (FACO)](https://faco.cl/).

### Descripción:

En el curso Introducción al desarrollo web desde el diseño, el estudiantado se aproximará a la descripción y programación de la cara visible de sitios y aplicaciones web (cara visible también llamada *frontend*). 
...
Según [Calendario de Actividades Académicas y Estudiantiles 2025](https://registrosacademicos.uc.cl/wp-content/uploads/2025/11/Calendario-de-Actividades-Academicas-y-Estudiantiles-2025.pdf), las clases del **segundo semestre del año 2025 comienzan el día lunes 4 de agosto y finalizan el viernes 28 de noviembre**. Los exámenes de cursos mínimos y optativos están programados entre lunes 1 y lunes 15 de diciembre.

Nuestro horario de clases: **Viernes en módulos 3 y 4, esto es entre 11:00 y 13:30 hrs. (sala PENDIENTE)**
...
[Clase 03 → 22/08/2025](https://github.com/profesorfaco/opr/tree/main/clase-03) → Comprendiendo dos lenguajes de descripción y una biblioteca de un lenguaje de programación: HTML5, CSS3 y p5.js
...
Clase 07 → 19/09/2025 → Receso de docencia bimestral (Se suspenden las clases; las evaluaciones académicas quedarán suspendidas entre el lunes 16 y el lunes 23 de septiembre)

[Clase 08 → 26/09/2025](https://github.com/profesorfaco/opr/tree/main/clase-08) → Aplicando HTML5, CSS3 y JS sin bibliotecas

**[Clase 09 → 03/10/2023](https://github.com/profesorfaco/opr/tree/main/clase-09) → Evaluación Nº2 (lunes 7 de octubre es el último día para retiro voluntario de cursos)**

[Clase 10 → 10/10/2025](https://github.com/profesorfaco/opr/tree/main/clase-10) → Conociendo Bootstrap v5.3

[Clase 11 → 17/10/2025](https://github.com/profesorfaco/opr/tree/main/clase-11) → Comprendiendo Bootstrap v5.3

[Clase 12 → 24/10/2025](https://github.com/profesorfaco/opr/tree/main/clase-12) → Aplicando Bootstrap v5.3

**[Clase 13 → 31/10/2023](https://github.com/profesorfaco/opr/tree/main/clase-13) → Evaluación Nº2**

[Clase 14 → 07/11/2025](https://github.com/profesorfaco/opr/tree/main/clase-14) → Diseño y desarrollo de su primer sitio web profesional o prototipo avanzado de aplicación web.

[Clase 15 → 14/11/2025](https://github.com/profesorfaco/opr/tree/main/clase-15) → Diseño y desarrollo de su primer sitio web profesional o prototipo avanzado de aplicación web.

[Clase 16 → 21/11/2020](https://github.com/profesorfaco/opr/tree/main/clase-16) → Diseño y desarrollo de su primer sitio web profesional o prototipo avanzado de aplicación web.

**[Clase 17 → 28/11/2025](https://github.com/profesorfaco/opr/tree/main/clase-17) → Pre-evaluación Nº3**

**[Clase 18 → 5/12/2025](https://github.com/profesorfaco/opr/tree/main/clase-18) → Evaluación Nº3**
